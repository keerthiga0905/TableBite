...
export const LandingPage: React.FC<LandingPageProps> = ({
  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2] text-slate-900 overflow-x-hidden">
      <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-amber-100/80">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-orange-600 via-amber-600 to-terracotta text-white flex items-center justify-center font-black text-xl shadow-lg shadow-orange-600/20">
              TB
            </div>
            <div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-orange-50 hover:bg-orange-100 text-orange-950 font-bold text-xs border border-orange-200 flex items-center gap-1.5 transition-all shadow-2xs"
            >
            ...
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs flex items-center gap-1.5 transition-all shadow-md"
            >
            ...
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-white hover:bg-slate-50 text-slate-800 font-bold text-xs border border-slate-200 flex items-center gap-1.5 transition-all hidden sm:flex"
            >
      ...
      <section className="relative pt-12 pb-20 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-100/80 border border-amber-200 text-amber-950 font-extrabold text-xs">
              <Sparkles className="w-4 h-4 text-orange-600" />
              <span>General Digital Cafe Ordering Platform</span>
            </div>

            <h1 className="text-4xl sm:text-5xl xl:text-6xl font-black text-slate-900 leading-[1.1] tracking-tight">
              Your Table. <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 via-amber-600 to-terracotta">
                Your Menu.
              </span>{' '}
              <br />
              Your Order.
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              ...
              <button
                onClick={() => onLaunchKitchen()}
                className="px-6 py-4 rounded-2xl bg-slate-900 hover:bg-slate-800 text-white font-bold text-sm shadow-md transition-all flex items-center gap-2"
              >
                <ChefHat className="w-4 h-4 text-amber-400" />
            ...
            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-amber-200/60 text-xs">
              <div>
              ...
              <div>
                <span className="block font-black text-xl text-slate-900">100%</span>
                <span className="text-slate-500 font-semibold">Table-Context Aware</span>
              </div>
              <div>
                <span className="block font-black text-xl text-slate-900">Realtime</span>
                <span className="text-slate-500 font-semibold">Kitchen KDS Sync</span>
              </div>
            </div>
          </div>

          <div className="lg:col-span-6 relative">
            <div className="absolute -inset-4 bg-gradient-to-tr from-orange-400/20 via-amber-300/20 to-rose-400/20 rounded-[3rem] blur-2xl -z-10"></div>

            <div className="bg-white rounded-3xl p-6 border border-amber-100 shadow-2xl space-y-6 relative overflow-hidden">
              <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-2xl bg-orange-600 text-white flex items-center justify-center font-black text-base shadow-sm">
                    04
                  </div>
                  <div>
                    <h3 className="font-extrabold text-slate-900 text-sm">Table 04 Simulation</h3>
                    <p className="text-slate-400 text-xs">TableBite Live Interactive Flow</p>
                  </div>
                </div>
              ...
              <div className="bg-slate-950 text-white p-5 rounded-2xl space-y-4 shadow-inner">
                ...
                <div className="flex justify-between items-center pt-2">
                  ...
                  <button
                    ...
                    className="px-3.5 py-1.5 bg-orange-600 hover:bg-orange-500 text-white text-xs font-bold rounded-xl flex items-center gap-1 transition-all"
                  >
                    <span>Next Step</span>
              ...
              <div className="bg-amber-50/60 p-4 rounded-2xl border border-amber-200/60 flex items-center justify-between">
                ...
                <button
                  onClick={() => onLaunchCustomer('04')}
                  className="px-3 py-2 bg-orange-600 text-white rounded-xl text-xs font-bold hover:bg-orange-700 transition-colors shadow-sm"
                >
                  Test Order
                </button>
              </div>
      ...
      <section className="py-16 bg-white border-y border-amber-100 px-6">
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-rose-50/50 p-6 rounded-3xl border border-rose-200/60 space-y-4">
            ...
            <div className="bg-emerald-50/50 p-6 rounded-3xl border border-emerald-200/60 space-y-4">
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto space-y-12">
        <div className="text-center max-w-2xl mx-auto space-y-3">
          <span className="text-xs font-bold text-orange-600 uppercase tracking-widest">SIMPLE 4-STEP WORKFLOW</span>
          <h2 className="text-3xl sm:text-4xl font-black text-slate-900">How TABLEBITE Works</h2>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            const Icon = s.icon;
            return (
              <div key={s.step} className="bg-white p-6 rounded-3xl border border-amber-100 shadow-sm space-y-4 hover:shadow-md transition-shadow">
      ...
      <section className="py-16 bg-gradient-to-r from-slate-900 via-charcoal to-slate-800 text-white px-6">
        <div className="max-w-5xl mx-auto text-center space-y-8">
          <div className="space-y-3">
            <span className="bg-amber-500/20 text-amber-300 text-xs font-bold px-3.5 py-1 rounded-full border border-amber-500/30 uppercase tracking-wider">
              Live Jury Demo Suite
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            <div
              onClick={() => onLaunchCustomer('04')}
              className="bg-slate-950 p-6 rounded-3xl border border-slate-800 hover:border-orange-500 cursor-pointer transition-all group space-y-3"
            >
              ...
              <p className="text-slate-400 text-xs">Simulate Table 04 scan, browse 26 dishes, customize, place order, and track status.</p>
            ...
            <div
              onClick={() => onLaunchKitchen()}
              className="bg-slate-950 p-6 rounded-3xl border border-slate-800 hover:border-amber-500 cursor-pointer transition-all group space-y-3"
            >
              ...
              <p className="text-slate-400 text-xs">Realtime Kanban (New → Preparing → Ready → Served), sound alerts, and staff requests.</p>
            ...
            <div
              onClick={() => onLaunchAdmin()}
              className="bg-slate-950 p-6 rounded-3xl border border-slate-800 hover:border-purple-500 cursor-pointer transition-all group space-y-3"
            >
              ...
              <p className="text-slate-400 text-xs">Analytics charts, table QR card generator, batch printable sheets, and menu CRUD.</p>
