...
export const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2] text-slate-900 pb-16">
      <header className="bg-slate-900 text-white border-b border-slate-800 px-6 py-4 sticky top-0 z-30 shadow-md">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-orange-600 to-amber-600 flex items-center justify-center font-black text-xl text-white shadow-md">
              TB
            </div>
            <div>
              ...
              <p className="text-slate-400 text-xs mt-0.5">SaaS Cafe Management & Realtime Analytics</p>
            </div>
          </div>
