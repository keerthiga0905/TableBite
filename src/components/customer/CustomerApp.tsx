...
export const CustomerApp: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2] text-slate-900 pb-28">
        ...
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative">
              <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-orange-600 to-amber-600 text-white flex items-center justify-center font-black text-lg shadow-md shadow-orange-500/20">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="p-2.5 rounded-2xl bg-amber-50 text-amber-900 hover:bg-amber-100 border border-amber-200/60 font-bold text-xs flex items-center gap-1.5 transition-colors"
            >
            ...
            {activeOrdersForTable.length > 0 && (
              <button
                ...
                className="relative p-2.5 rounded-2xl bg-emerald-50 text-emerald-900 hover:bg-emerald-100 border border-emerald-200/60 font-bold text-xs flex items-center gap-1.5 transition-colors"
              >
      ...
      <main className="max-w-3xl mx-auto px-4 pt-4 space-y-5">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-slate-900 via-charcoal to-slate-800 p-5 text-white shadow-xl">
          <div className="relative z-10 space-y-1">
            <span className="text-xs font-bold text-amber-400 uppercase tracking-widest flex items-center gap-1">
              <Sparkles className="w-3.5 h-3.5" /> Sit. Order. Enjoy.
            </span>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-3.5 bg-white rounded-2xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-orange-500/30 focus:border-orange-500 text-xs sm:text-sm font-medium shadow-xs text-slate-900 placeholder:text-slate-400"
          />
        </div>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <h3 className="font-extrabold text-sm text-slate-800 uppercase tracking-wider">Categories</h3>
            <span className="text-xs text-slate-400 font-semibold">{filteredItems.length} items available</span>
          </div>
        ...
        <div className="space-y-3">
          {filteredItems.length === 0 ? (
            <div className="bg-white rounded-3xl p-10 text-center space-y-2 border border-slate-100">
      ...
      <div className="fixed bottom-4 left-0 right-0 z-40 px-4">
        <div className="max-w-3xl mx-auto flex items-center gap-3">
          <button
            ...
            className="bg-slate-900 hover:bg-slate-800 text-white px-4 py-3.5 rounded-2xl font-bold text-xs shadow-xl flex items-center gap-2 transition-all hover:scale-105 active:scale-95 border border-slate-700"
          >
          ...
          <button
            ...
            className={`flex-1 py-3.5 px-5 rounded-2xl font-extrabold text-xs sm:text-sm shadow-xl flex items-center justify-between transition-all ${
              cartTotalItems > 0
                ? 'bg-gradient-to-r from-orange-600 to-amber-600 text-white shadow-orange-600/30 hover:opacity-95 active:scale-[0.99]'
